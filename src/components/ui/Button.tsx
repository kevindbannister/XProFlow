  ...
  return (
    <button
      className={classNames(
        ...
        variant === 'ghost' && 'text-slate-600 hover:bg-blue-50',
        variant === 'outline' &&
          'border border-blue-200/70 bg-white/70 text-blue-600 hover:bg-white',
        variant === 'soft' && 'bg-blue-50 text-blue-600 hover:bg-blue-100',
