  ...
  return (
    <aside
      className={classNames(
        'sidebar-surface fixed inset-y-0 left-0 z-40 flex h-full flex-col border-r py-8 transition-all',
        ...
        <div className="flex items-center gap-2">
          {showCollapseToggle && (
            <button
              ...
              onClick={onToggle}
              className="rounded-full border border-slate-200 bg-white p-1 text-slate-600 transition hover:text-slate-900 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-300 dark:hover:text-slate-100"
            >
              {collapsed ? (
