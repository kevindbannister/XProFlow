  ...
  return (
    <div className="space-y-6">
      <div className="rounded-3xl border border-slate-200 bg-white/90 p-6 shadow-sm">
        ...
        <div className="mt-6">
          <button className="rounded-full border border-slate-200 px-6 py-2 text-sm font-semibold text-slate-700">
            Update profile
          </button>
        </div>
      </div>
      <div className="rounded-3xl border border-slate-200 bg-white/90 p-6 shadow-sm">
        ...
        <div className="mt-3 flex items-center justify-between">
          ...
          >
            <span
              className={`inline-block h-4 w-4 rounded-full bg-white transition ${darkMode ? 'translate-x-5' : 'translate-x-1'}`}
            />
          </button>
        </div>
      </div>
